...
import { DeferredPromise } from "@ecad-viewer/base/src/async";
import { delegate, listen } from "@ecad-viewer/base/src/events";
import {
    css,
    html,
    type ElementOrFragment,
} from "@ecad-viewer/base/src/web-components";
import { KCUISelectElement, KCUIElement } from "../../../kc-ui";
import type { KicadPCB, KicadSch } from "kicad-parser/src/kicad";
import {
    KiCanvasSelectEvent,
