...
class MMDAnimationHelper {
    ...
    pose(mesh, vpd, params = {}) {
        ...
        for (let i = 0, il = boneParams.length; i < il; i++) {
            ...
            bone.quaternion.multiply(
                quaternion.fromArray(boneParam.quaternion),
            );
        }
    ...
    _setupMeshPhysics(mesh, params) {
        ...
        objects.physics.warmup(
            params.warmup !== undefined ? params.warmup : 60,
        );
        ...
        for (let i = 0, il = iks.length; i < il; i++) {
            ...
            for (let j = 0, jl = links.length; j < jl; j++) {
                ...
                if (physicsEnabled === true) {
                    ...
                    link.enabled =
                        bones[link.index].rigidBodyType > 0 ? false : true;
                } else {
                    link.enabled = true;
                }
            }
        ...
        for (let i = 0, il = links.length; i < il; i++) {
            ...
            if (_grantResultMap.has(linkIndex)) {
                _grantResultMap.set(
                    ...
                    _grantResultMap
                        .get(linkIndex)
                        .copy(bones[linkIndex].quaternion),
                );
            }
        }
    }
...
class AudioManager {
    ...
    constructor(audio, params = {}) {
        ...
        this.delayTime =
            params.delayTime !== undefined ? params.delayTime : 0.0;
