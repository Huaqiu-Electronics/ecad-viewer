...
export type ProjectZipSource = string | URL | Blob | ArrayBuffer | Uint8Array | Response;
export interface ProjectZipFile { filename: string; content: string; }
export interface LoadedProjectZip { files: ProjectZipFile[]; rootSchematic: string; }
export interface RenderProjectOptions extends RenderOptions { kind?: "auto" | "schematic" | "pcb"; }
...
export declare function loadProjectZip(source: ProjectZipSource): Promise<LoadedProjectZip>;
export declare function renderProjectFromZip(source: ProjectZipSource, options?: RenderProjectOptions): Promise<RenderResult>;
