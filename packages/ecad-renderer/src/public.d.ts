...
export declare function renderSymbol(
    symbol: Symbol,
    options?: RenderOptions,
): Promise<RenderResult>;
export declare function renderFootprint(
    footprint: Footprint,
    options?: RenderOptions,
): Promise<RenderResult>;
export declare function renderSchematic(
    schematic: Schematic,
    options?: RenderOptions,
): Promise<RenderResult>;
export declare function renderPcb(
    pcb: Pcb,
    options?: RenderOptions,
): Promise<RenderResult>;
export type RendererRequest = {
    id: string;
    type: "symbol" | "footprint" | "schematic" | "pcb";
    model: unknown;
};
...
export declare function createRendererClient(worker: Worker): {
