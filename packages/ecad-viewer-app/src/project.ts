...
import { sorted_by_numeric_strings } from "@ecad-viewer/base/src/array";
import { Barrier } from "@ecad-viewer/base/src/async";
import { type IDisposable } from "@ecad-viewer/base/src/disposable";
import { first, length, map } from "@ecad-viewer/base/src/iterator";
import { Logger } from "@ecad-viewer/base/src/log";

import { KicadPCB, KicadSch, ProjectSettings } from "kicad-parser/src/kicad";
import * as Comlink from "comlink";
import {
    BoardBomItemVisitor,
    type DesignatorRef,
} from "kicad-parser/src/kicad/board_bom_visitor";
import type { BomItem } from "kicad-parser/src/kicad/bom_item";
import { ItemsGroupedByFpValueDNP } from "kicad-parser/src/kicad/ItemsGroupedByFpValueDNP";
import { NetRef } from "kicad-parser/src/kicad/net_ref";
import type {
    SchematicSheet,
    SchematicSheetInstance,
} from "kicad-parser/src/kicad/schematic";
import { SchematicBomVisitor } from "kicad-parser/src/kicad/schematic_bom_visitor";
import { NewStrokeGlyph } from "kicad-parser/src/kicad/text/newstroke-glyphs";
