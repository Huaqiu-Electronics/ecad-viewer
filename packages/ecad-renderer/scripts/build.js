...
await build({
    entryPoints: ["src/index.ts", "src/symbol.ts", "src/footprint.ts", "src/schematic.ts", "src/pcb.ts", "src/project.ts", "src/worker.ts", "src/renderer.worker.ts"],
    outdir: "dist",
    bundle: true,
    format: "esm",
    platform: "browser",
...
for (const name of ["index", "symbol", "footprint", "schematic", "pcb", "project", "worker"]) {
