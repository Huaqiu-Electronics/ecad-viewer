...
RUN set -ex;            \
    ...
    git clone --depth 1  https://github.com/Huaqiu-Electronics/ecad-viewer.git;\
    git clone --depth 1  https://github.com/Huaqiu-Electronics/ecad-viewer-docker-scripts.git;
